...
export default function ContactCTASection() {
  return (
    <section 
      className="py-14 px-4 mb-[4rem] md:px-8 lg:px-16 xl:px-20 2xl:px-24 3xl:px-28 4xl:px-32"
      style={{
        background: 'linear-gradient(164deg, rgba(157, 41, 198, 0.40) 45.71%, rgba(88, 33, 153, 0.40) 211.04%), #5E2D91'
      }}
    >
      <div className="max-w-md mx-auto sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl 4xl:max-w-[90rem]">
